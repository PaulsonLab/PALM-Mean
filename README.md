...
Experiments can be run using the `main.py` script. You must specify the path for the .npy and .json files containing GP training data and hyperparameter settings.
